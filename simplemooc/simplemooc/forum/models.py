...
class Thread(models.Model):
    ...
    author = models.ForeignKey(
        settings.AUTH_USER_MODEL, verbose_name='Autor', on_delete=models.CASCADE, related_name='threads'
    )
...
class Reply(models.Model):
    ...
    thread = models.ForeignKey(
        Thread, verbose_name='Tópico', on_delete=models.CASCADE, related_name='replies'
    )
    reply = models.TextField('Resposta')
    author = models.ForeignKey(
        settings.AUTH_USER_MODEL, verbose_name='Autor', on_delete=models.CASCADE, related_name='replies'
    )
